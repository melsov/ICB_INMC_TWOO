...
namespace LibNoise.Unity
{
    internal static class Utils
    {
        ...
        private const int GeneratorSeed = 1013;
//		private const int GeneratorSeed = 77321; //MMP
        private const int GeneratorShift = 8;
//		private const int GeneratorShift = 3; //MMP
#endif
        ...
        internal static double MakeInt32Range(double value)
        {
            ...
            else if (value <= -1073741824.0) { return (2.0 * Math.IEEERemainder(value, 1073741824.0)) + 1073741824.0; }
            else { return value; }
        }
