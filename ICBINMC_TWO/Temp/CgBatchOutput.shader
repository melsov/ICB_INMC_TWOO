...
ADD R2.z, vertex.position.y, -R2.y;
SGE R0.z, c[0], R0.y;
...
ADD R2.z, R2, c[6].w;
MAD R1.w, R0.y, R2.z, R2.y;
ADD R2.x, vertex.position.y, -R1.w;
MOV R1.z, c[0].x;
ADD R1.z, -R1, c[5].x;
MUL R1.z, R1, c[0].y;
ADD R2.x, R2, c[6].w;
MAD R2.x, R0.z, R2, R1.w;
SLT R1.w, R1.z, c[0].z;
ADD R2.y, vertex.position, -R2.x;
ADD R2.y, R2, c[6].w;
MOV R2.z, c[6].w;
MUL R3.x, R1.z, R1.w;
ADD R2.w, -R1.z, c[7].x;
MAD R3.x, R3, c[7].y, R2.z;
MUL R2.z, R2.w, c[6].w;
MAD R2.w, R0.x, R2.z, R3.x;
MUL R0.x, R1.z, c[6].w;
MAD R0.y, R0.x, R0, R2.w;
MAD R0.y, R2.z, R0.z, R0;
MAD R0.y, R0.x, R0.w, R0;
MAD R0.z, R1, c[6], -R0.y;
ABS R0.x, R1;
SGE R0.x, c[0].z, R0;
ADD R0.z, R0, c[7];
MUL R0.x, R1.y, R0;
...
add r2.y, -r2.x, c6.x
mul r2.z, r2.y, r2.w
mad r2.y, r1, c7.z, c7.w
mad r2.y, r2.x, r2, r2.z
max r1.w, -r1, r1
slt r1.w, c5.y, r1
mad r2.x, r1.y, c6.w, r2.y
add r2.z, -r1.w, c6.x
mul r1.y, r2, r2.z
max r2.z, -r1.x, r1.x
mad oD0.z, r1.w, r2.x, r1.y
slt r0.w, c5.y, r0.x
slt r1.w, c5.y, r1.z
add r2.y, -r0.z, c6.x
add r1.x, v0, c5.w
mul r2.w, r1.x, r2.y
mad r2.w, r0.z, -r1.x, r2
add r1.x, -r0.y, c6
mul r2.w, r1.x, r2
add r3.x, v0.z, c5.w
add r0.x, -r1.w, c6
mul r2.x, r3, r0
add r0.x, v0.y, c5.w
mad r1.w, r1, r0.x, r2.x
slt r2.z, c5.y, r2
mad r3.y, r0, -r3.x, r2.w
add r2.w, -r2.z, c6.x
mul r3.y, r2.w, r3
mad r1.y, r2.z, r3.x, r3
add r1.z, -r0.w, c6.x
mul r1.z, r1.y, r1
mul r1.w, r2.y, r1
mad oT0.x, r0.w, -r1.y, r1.z
...
void main ()
{
  ...
  tmpvar_1 = ((texture2D (_BlockTex, tmpvar_4) * xlv_COLOR.z) * xlv_);
...
adaaaaaaabaaacacaaaaaaaaacaaaaaaagaaaakkabaaaaaa mul r1.y, r0.x, c6.z
ckaaaaaaabaaaiacabaaaaffacaaaaaaafaaaaffabaaaaaa slt r1.w, r1.y, c5.y
...
adaaaaaaaaaaacacabaaaaffacaaaaaaahaaaaaaabaaaaaa mul r0.y, r1.y, c7.x
...
ckaaaaaaabaaabacabaaaakkaaaaaaaaafaaaakkabaaaaaa slt r1.x, a1.z, c5.z
adaaaaaaaaaaaeacaaaaaaffacaaaaaaabaaaaaaacaaaaaa mul r0.z, r0.y, r1.x
...
cjaaaaaaabaaaeacafaaaaffabaaaaaaabaaaaaaacaaaaaa sge r1.z, c5.y, r1.x
cjaaaaaaabaaabacabaaaaaaacaaaaaaafaaaaffabaaaaaa sge r1.x, r1.x, c5.y
adaaaaaaabaaabacabaaaaaaacaaaaaaabaaaakkacaaaaaa mul r1.x, r1.x, r1.z
...
adaaaaaaaaaaacacabaaaaaaacaaaaaaabaaaakkacaaaaaa mul r0.y, r1.x, r1.z
...
adaaaaaaacaaaeacabaaaaaaacaaaaaaacaaaakkacaaaaaa mul r2.z, r1.x, r2.z
adaaaaaaabaaabacacaaaakkacaaaaaaabaaaakkacaaaaaa mul r1.x, r2.z, r1.z
bfaaaaaaaeaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa neg r4.x, r1.x
ahaaaaaaacaaaiacaeaaaaaaacaaaaaaabaaaaaaacaaaaaa max r2.w, r4.x, r1.x
...
adaaaaaaaaaaaiacabaaaakkacaaaaaaaaaaaappacaaaaaa mul r0.w, r1.z, r0.w
bfaaaaaaaeaaabacaaaaaaaaacaaaaaaaaaaaaaaaaaaaaaa neg r4.x, r0.x
ahaaaaaaabaaaeacaeaaaaaaacaaaaaaaaaaaaaaacaaaaaa max r1.z, r4.x, r0.x
bfaaaaaaaeaaaiacaaaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r4.w, r0.w
ahaaaaaaaaaaabacaeaaaappacaaaaaaaaaaaappacaaaaaa max r0.x, r4.w, r0.w
...
adaaaaaaacaaacacabaaaaffacaaaaaaahaaaakkabaaaaaa mul r2.y, r1.y, c7.z
...
adaaaaaaaeaaabacabaaaaffacaaaaaaagaaaappabaaaaaa mul r4.x, r1.y, c6.w
...
adaaaaaaabaaacacacaaaaffacaaaaaaacaaaakkacaaaaaa mul r1.y, r2.y, r2.z
bfaaaaaaaeaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa neg r4.x, r1.x
ahaaaaaaacaaaeacaeaaaaaaacaaaaaaabaaaaaaacaaaaaa max r2.z, r4.x, r1.x
adaaaaaaaeaaaeacabaaaappacaaaaaaacaaaaaaacaaaaaa mul r4.z, r1.w, r2.x
abaaaaaaahaaaeaeaeaaaakkacaaaaaaabaaaaffacaaaaaa add v7.z, r4.z, r1.y
ckaaaaaaaaaaaiacafaaaaffabaaaaaaaaaaaaaaacaaaaaa slt r0.w, c5.y, r0.x
ckaaaaaaabaaaiacafaaaaffabaaaaaaabaaaakkacaaaaaa slt r1.w, c5.y, r1.z
bfaaaaaaaeaaaeacaaaaaakkacaaaaaaaaaaaaaaaaaaaaaa neg r4.z, r0.z
abaaaaaaacaaacacaeaaaakkacaaaaaaagaaaaaaabaaaaaa add r2.y, r4.z, c6.x
abaaaaaaabaaabacaaaaaaoeaaaaaaaaafaaaappabaaaaaa add r1.x, a0, c5.w
adaaaaaaacaaaiacabaaaaaaacaaaaaaacaaaaffacaaaaaa mul r2.w, r1.x, r2.y
bfaaaaaaaeaaabacabaaaaaaacaaaaaaaaaaaaaaaaaaaaaa neg r4.x, r1.x
adaaaaaaaeaaaiacaaaaaakkacaaaaaaaeaaaaaaacaaaaaa mul r4.w, r0.z, r4.x
abaaaaaaacaaaiacaeaaaappacaaaaaaacaaaappacaaaaaa add r2.w, r4.w, r2.w
bfaaaaaaaeaaacacaaaaaaffacaaaaaaaaaaaaaaaaaaaaaa neg r4.y, r0.y
abaaaaaaabaaabacaeaaaaffacaaaaaaagaaaaoeabaaaaaa add r1.x, r4.y, c6
adaaaaaaacaaaiacabaaaaaaacaaaaaaacaaaappacaaaaaa mul r2.w, r1.x, r2.w
...
adaaaaaaacaaabacadaaaaaaacaaaaaaaaaaaaaaacaaaaaa mul r2.x, r3.x, r0.x
...
adaaaaaaabaaacacacaaaakkacaaaaaaadaaaaaaacaaaaaa mul r1.y, r2.z, r3.x
abaaaaaaabaaacacabaaaaffacaaaaaaadaaaaffacaaaaaa add r1.y, r1.y, r3.y
bfaaaaaaaeaaaiacaaaaaappacaaaaaaaaaaaaaaaaaaaaaa neg r4.w, r0.w
...
adaaaaaaaeaaabacaaaaaappacaaaaaaaeaaaaffacaaaaaa mul r4.x, r0.w, r4.y
abaaaaaaaaaaabaeaeaaaaaaacaaaaaaabaaaakkacaaaaaa add v0.x, r4.x, r1.z
adaaaaaaaaaaaiacaaaaaakkacaaaaaaaaaaaaaaacaaaaaa mul r0.w, r0.z, r0.x
...
adaaaaaaaeaaabacaaaaaaffacaaaaaaaaaaaaaaacaaaaaa mul r4.x, r0.y, r0.x
abaaaaaaabaaabacaeaaaaaaacaaaaaaabaaaaaaacaaaaaa add r1.x, r4.x, r1.x
adaaaaaaaaaaaiacaaaaaakkacaaaaaaahaaaakkabaaaaaa mul r0.w, r0.z, c7.z
aiaaaaaaaaaaacacaaaaaappacaaaaaaaaaaaaaaaaaaaaaa frc r0.y, r0.w
adaaaaaaabaaabacacaaaappacaaaaaaabaaaaaaacaaaaaa mul r1.x, r2.w, r1.x
acaaaaaaaaaaacacaaaaaappacaaaaaaaaaaaaffacaaaaaa sub r0.y, r0.w, r0.y
...
adaaaaaaaaaaapacaaaaaaoeacaaaaaaahaaaakkaeaaaaaa mul r0, r0, v7.z
